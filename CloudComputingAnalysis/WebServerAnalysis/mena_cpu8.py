...
print('with cpu=8,number=1000000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=500000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=200000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=100000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=20000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=10000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=5000: mean %f, standard deviation %f' % (n.mean(), n.std()))
...
print('with cpu=8,number=1000: mean %f, standard deviation %f' % (n.mean(), n.std()))
############################################################################################
runtime_0 = data[data[:,1] == 8]
...
print('with cpu=8,number=100: mean %f, standard deviation %f' % (n.mean(), n.std()))
